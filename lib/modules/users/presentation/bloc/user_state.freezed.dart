...
mixin _$UserState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<UserEntity> users, bool showOnlyBookmarked)
        loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<UserEntity> users, bool showOnlyBookmarked)? loaded,
...
abstract class _$$LoadedStateImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<UserEntity> users, bool showOnlyBookmarked});
}
...
class _$LoadedStateImpl implements _LoadedState {
  const _$LoadedStateImpl(
      {required final List<UserEntity> users, this.showOnlyBookmarked = false})
      : _users = users;
  ...
  @override
  String toString() {
    return 'UserState.loaded(users: $users, showOnlyBookmarked: $showOnlyBookmarked)';
  }
  ...
  int get hashCode => Object.hash(runtimeType,
      const DeepCollectionEquality().hash(_users), showOnlyBookmarked);
  ...
  TResult when<TResult extends Object?>({
    ...
    return loaded(users, showOnlyBookmarked);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return loaded?.call(users, showOnlyBookmarked);
  }
...
abstract class _LoadedState implements UserState {
  const factory _LoadedState(
      ...
      final bool showOnlyBookmarked}) = _$LoadedStateImpl;
